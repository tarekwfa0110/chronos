-- Supabase Database Setup for Chronos E-commerce (Fixed Version)
-- Run these queries in your Supabase SQL Editor

-- 1. Enable Row Level Security (RLS) on existing products table
...
-- 13. Create function to generate order numbers (AFTER orders table is created)
...
-- 15. Insert sample data (optional - for testing)
-- You can uncomment these lines if you want to add some test data

-- INSERT INTO products (id, name, price, image_url, category, description) VALUES
--   (gen_random_uuid(), 'Classic Chronograph', 299.99, '/sample-watch-1.jpg', 'men', 'Elegant chronograph watch with leather strap'),
--   (gen_random_uuid(), 'Sport Digital', 199.99, '/sample-watch-2.jpg', 'sports', 'Water-resistant digital sports watch'),
--   (gen_random_uuid(), 'Luxury Diamond', 899.99, '/sample-watch-3.jpg', 'women', 'Premium diamond-encrusted luxury watch'); 