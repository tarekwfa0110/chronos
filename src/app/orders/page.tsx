        ...
        <main className="max-w-4xl mx-auto py-16 px-4 sm:px-8 min-h-screen">
            ...
            {filteredOrders.length === 0 ? (
                <div className="bg-card rounded-2xl shadow-lg border border-border p-8 text-center">
                    ...
                    <Button
                        onClick={() => router.push("/")}
                        className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-xl transition-all duration-200"
                    >
                        Browse Products
                    </Button>
                </div>
                ...
                <div className="space-y-4">
                    {filteredOrders.map((order) => (
                        <Link
                            ...
                            className="block bg-card rounded-2xl shadow-sm border border-border p-6 hover:shadow-md transition-all duration-200"
                        >
