...
export default function ProductCard({ product, onAddToCart, onBuyNow, showActions = true }: ProductCardProps) {
  ...
  return (
    <div className="group flex flex-col bg-card rounded-2xl shadow-lg overflow-hidden border border-border hover:shadow-2xl hover:border-border/60 transition-all duration-300 transform hover:-translate-y-2">
      ...
      <div className="p-6 space-y-4">
        ...
        {showActions && (
          <div className="flex gap-3">
            ...
            <button
              onClick={onBuyNow}
              className="flex-1 bg-primary text-primary-foreground py-3 px-4 rounded-xl font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-2"
              aria-label="Buy Now"
            >
