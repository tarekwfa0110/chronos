...
export function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50 bg-background/95 backdrop-blur-sm border-b border-border h-14 sm:h-16 md:h-18 flex items-center justify-around px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="flex flex-1 justify-end items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4 min-w-0">
                ...
                <button 
                    ...
                    className="relative p-1.5 sm:p-2 md:p-2.5 rounded-full hover:bg-muted transition-colors group"
                >
                        ...
                        {user ? (
                            <div className="relative" ref={userMenuRef}>
                                <button
                                    ...
                                    className="p-1.5 sm:p-2 md:p-2.5 rounded-full hover:bg-muted transition-colors group"
                                ...
                                {showUserMenu && (
                                    <div 
                                        className="absolute right-0 top-full mt-2 w-44 sm:w-48 md:w-52 lg:w-56 bg-card rounded-xl shadow-xl border border-border py-2 text-sm animate-in slide-in-from-top-2 duration-200"
                                        role="menu"
                                        aria-label="User menu"
                                    >
                            ...
                            <Link
                                href="/auth/signin"
                                className="px-3 md:px-4 lg:px-5 py-2 md:py-2.5 text-sm md:text-base font-medium text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-all duration-200"
                            >
                                Sign In
                            </Link>
                        )}
